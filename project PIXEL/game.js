...
let map = [
    ...
    [1, 2, 2, 2, 2, 2, 1, 2, 2, 2, 2, 2, 2, 2, 1, 2, 1, 0, 0, 0, 1],
...
let drawWin = () => {
    ...
    canvasContext.fillText("LEVEL PASSED !!", 150,200)
    canvasContext.fillStyle("BEST RECORD ", 150, 350)
...
let drawGameOver = () => {
    canvasContext.font = "20px Emulogic";
    canvasContext.fillStyle = "white";
    canvasContext.fillText("GAME OVER !!",154,200)
};
